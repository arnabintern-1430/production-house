      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 px-6">
        ...
        <div className="flex flex-col justify-center text-white space-y-8">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            ...
            form or reach us through the details below.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <span className="text-gray-300 leading-relaxed">
                5/64 Netaji Nagar Post Office Regent Park, Tollyguange Netaji
                Nagar, Netaji Nagar Sub Post Office, Kolkata, West Bengal -
                700040
              </span>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-300">+91 98318 96104</span>
            </div>
            <div className="flex items-center gap-4">
